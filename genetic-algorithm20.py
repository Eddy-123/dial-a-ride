...
class Instance:
    ...
    starting_time = {
        ...
        'pr16': [71.77, 25.83, 42.16, 56.29, 83.43, 0.00, 0.00, 0.00, 100.93, 117.25, 76.07, 69.52, 114.09],
        'pr17': [81.11, 231.43, 116.86, 265.79],
        'pr19': [93.88, 160.75, 124.21, 146.67, 33.93, 18.34, 105.64, 120.65],
        'pr20': [78.40, 68.41, 227.59, 117.22, 202.48, 60.27, 37.06, 100.20, 103.90, 79.83]
        }
    name = 'pr20'
    
    @classmethod
    def read(cls, instance_path = 'instances/pr20.txt'):
        cls.vertices = []
